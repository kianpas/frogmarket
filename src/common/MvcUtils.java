...
public class MvcUtils {
	...
	/**
	 * 단방향 암호화 알고리즘 - md5 - sha1 - 이것만 160byte - sha256 - sha512
	 * 
	...
	/**
	 * 1. cPage 2. numPerPage 3. totalContents 총 컨텐츠 수 4. url 이동할 주소
	 * /mvc/admin/memberList?cPage=
	 * -------------------------------------------------------------- 5. totalPage
	 * 전체페이지수 - pageNo 넘침 방지 6. pageBarSize 페이지바에 표시할 페이지 개수 ex)5일경우 :
	 * (<이전,6~10,다음>) 7. pageStart ~pageEnd pageNo의 범위 8. pageNo 페이지넘버를 출력할 증감변수
	 * 
	 * @param cPage
	 * @param numPerPage
	 * @param totalContents
	...
	public static String getPageBar(int cPage, int numPerPage, int totalContents, String url) {
		...
		/**
		 * 1 2 3 4 5 ---> 1 = n*pageBarSize+1 6 7 8 9 10 ---> 6 11 12 13 14 15 ---> 11
		 * ... 11 = (cPage-1)/pageBarSize*pageBarSize+1 int pageStart =
		 * (cPage-1)/pageBarSize*pageBarSize+1; 이것은 공식
		 */
		...
		/*
		 * <a href='/mvc/admin/memberList?cPage=5'/>prev</a> <a
		 * href='/mvc/admin/memberList?cPage=6'/>6</a> <span class='cPage'>7</span> <a
		 * href='/mvc/admin/memberList?cPage=8'/>8</a> <a
		 * href='/mvc/admin/memberList?cPage=9'/>9</a> <a
		 * href='/mvc/admin/memberList?cPage=10'/>10</a> <a
		 * href='/mvc/admin/memberList?cPage=11'/>next</a>
		 */
