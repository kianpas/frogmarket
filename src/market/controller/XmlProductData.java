 ...
 */
@WebServlet("/market/XmlProductData")
public class XmlProductData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/views/market/markets.jsp").forward(request, response);
	}
